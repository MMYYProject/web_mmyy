...
export const constantRoutes = [
  ...
  {
    path: '/discountsSetting',
    component: Layout,
    redirect: '/discountsSetting/discountCouponAdd',
    name: 'discountsSetting',
    meta: { title: '优惠券设置', icon: 'nested' },
    children: [
      {
        path: 'discountCouponAdd',
        name: 'discountCouponAdd',
        component: () => import('@/views/discountsSetting/discountCouponAdd'),
        meta: { title: '优惠券添加', icon: 'example' }
      },
      {
        path: 'discountCouponManage',
        name: 'discountCouponManage',
        component: () => import('@/views/discountsSetting/discountCouponManage'),
